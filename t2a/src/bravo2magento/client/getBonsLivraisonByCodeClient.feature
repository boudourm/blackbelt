Feature: test du GET des bons de livraison d un client
...
Scenario: GET de tous les bons de livraison d un client
    Given path 'v1/client', codeClient_param, 'bon-de-livraison'
